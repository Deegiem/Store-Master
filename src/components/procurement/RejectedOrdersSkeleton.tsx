// src/components/procurement/RejectedOrdersSkeleton.tsx
"use client"

export function RejectedOrdersSkeleton() {
  return (
        ...
        <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="rounded-sm border border-slate-200 bg-white p-5">
              ...
              <div className="mt-3 h-8 w-full bg-slate-200 rounded animate-pulse" />
            </div>
          ))}
        </div>
      </div>

// src/app/dashboard/admin/procurement/page.tsx
"use client"
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        >
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <button
              onClick={() => router.push("/dashboard/admin/procurement/pending-approval")}
        ...
        <ProcurementStats
          ...
          totalValue={list.reduce((acc, item) => acc + item.total_amount, 0)}
        />
